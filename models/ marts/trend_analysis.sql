...
select county, city, model_year, count(vin) as registered_vehicles
from electric_vehicle
group by county, city, model_year
order by county, city, model_year;
...
select electric_vehicle_type, avg(base_msrp) as avg_base_msrp
from electric_vehicle
